...
$(document).ready(function() {
    var title1 = $(".title-1"),
        title2 = $(".title-2"),
        title3 = $(".title-3"),
        lineBottom1 = $(".item-img-1 .item-bottom"),
        lineLeft1 = $(".item-img-1 .item-left"),
        lineTop1 = $(".item-img-1 .item-top"),
        lineRight1 = $(".item-img-1 .item-right"),
        lineBottom2 = $(".item-img-2 .item-bottom"),
        lineLeft2 = $(".item-img-2 .item-left"),
        lineTop2 = $(".item-img-2 .item-top"),
        lineRight2 = $(".item-img-2 .item-right"),
        lineBottom3 = $(".item-img-3 .item-bottom"),
        lineLeft3 = $(".item-img-3 .item-left"),
        lineTop3 = $(".item-img-3 .item-top"),
        lineRight3 = $(".item-img-3 .item-right"),
        lineBottom4 = $(".item-img-4 .item-bottom"),
        lineLeft4 = $(".item-img-4 .item-left"),
        lineTop4 = $(".item-img-4 .item-top"),
        lineRight4 = $(".item-img-4 .item-right"),
        lineBottom5 = $(".item-img-5 .item-bottom"),
        lineLeft5 = $(".item-img-5 .item-left"),
        lineTop5 = $(".item-img-5 .item-top"),
        lineRight5 = $(".item-img-5 .item-right"),
        lineBottom6 = $(".item-img-6 .item-bottom"),
        lineLeft6 = $(".item-img-6 .item-left"),
        lineTop6 = $(".item-img-6 .item-top"),
        lineRight6 = $(".item-img-6 .item-right"),
        lineBottom7 = $(".item-img-7 .item-bottom"),
        lineLeft7 = $(".item-img-7 .item-left"),
        lineTop7 = $(".item-img-7 .item-top"),
        lineRight7 = $(".item-img-7 .item-right"),
        lineBottom8 = $(".item-img-8 .item-bottom"),
        lineLeft8 = $(".item-img-8 .item-left"),
        lineTop8 = $(".item-img-8 .item-top"),
        lineRight8 = $(".item-img-8 .item-right"),
        lineBottom9 = $(".item-img-9 .item-bottom"),
        lineLeft9 = $(".item-img-9 .item-left"),
        lineTop9 = $(".item-img-9 .item-top"),
        lineRight9 = $(".item-img-9 .item-right"),
        lineBottom10 = $(".item-img-10 .item-bottom"),
        lineLeft10 = $(".item-img-10 .item-left"),
        lineTop10 = $(".item-img-10 .item-top"),
        lineRight10 = $(".item-img-10 .item-right"),
        lineBottom11 = $(".item-img-11 .item-bottom"),
        lineLeft11 = $(".item-img-11 .item-left"),
        lineTop11 = $(".item-img-11 .item-top"),
        lineRight11 = $(".item-img-11 .item-right"),
        lineBottom12 = $(".item-img-12 .item-bottom"),
        lineLeft12 = $(".item-img-12 .item-left"),
        lineTop12 = $(".item-img-12 .item-top"),
        lineRight12 = $(".item-img-12 .item-right"),
        lineBottom13 = $(".item-img-13 .item-bottom"),
        lineLeft13 = $(".item-img-13 .item-left"),
        lineTop13 = $(".item-img-13 .item-top"),
        lineRight13 = $(".item-img-13 .item-right"),
        lineBottom14 = $(".item-img-14 .item-bottom"),
        lineLeft14 = $(".item-img-14 .item-left"),
        lineTop14 = $(".item-img-14 .item-top"),
        lineRight14 = $(".item-img-14 .item-right"),
        lineBottom15 = $(".item-img-15 .item-bottom"),
        lineLeft15 = $(".item-img-15 .item-left"),
        lineTop15 = $(".item-img-15 .item-top"),
        lineRight15 = $(".item-img-15 .item-right"),
        img1 = $(".item-img-1"),
        img2 = $(".item-img-2"),
        img3 = $(".item-img-3"),
        img4 = $(".item-img-4"),
    ...
    tl.to(title1, 0.3, { opacity: 1, transform: "translateY(10px)" })
        ...
        .to(lineTop1, 0.1, { width: "100%", ease: Power0.easeNone })
        .to(lineRight1, 0.1, { height: "100%", ease: Power0.easeNone }, "together0")
        .to(img1, 0.2, { backgroundSize: "100%", ease: Power0.easeNone }, "together0")
        .to(lineLeft4, 0.1, { height: "100%", ease: Power0.easeNone }, "-=0.1")
        .to(lineRight7, 0.1, { height: "100%", ease: Power0.easeNone }, "together1")
        .to(lineBottom4, 0.1, { width: "100%", ease: Power0.easeNone }, "together1")
        .to(lineBottom7, 0.1, { width: "100%", ease: Power0.easeNone }, "together2")
        .to(lineRight4, 0.1, { height: "100%", ease: Power0.easeNone }, "together2")
        .to(lineLeft10, 0.1, { height: "100%", ease: Power0.easeNone }, "together2")
        .to(lineLeft7, 0.1, { height: "100%", ease: Power0.easeNone }, "together3")
        .to(lineTop4, 0.1, { width: "100%", ease: Power0.easeNone }, "together3")
        .to(img4, 0.1, { backgroundSize: "100%", ease: Power0.easeNone }, "together3")
        .to(lineLeft2, 0.1, { height: "100%", ease: Power0.easeNone }, "together3")
        .to(lineBottom10, 0.1, { width: "100%", ease: Power0.easeNone }, "together3")
        .to(lineTop7, 0.1, { width: "100%", ease: Power0.easeNone }, "together4")
        .to(img7, 0.1, { backgroundSize: "100%", ease: Power0.easeNone }, "together4")
        .to(lineRight10, 0.1, { height: "100%", ease: Power0.easeNone }, "together4")
        .to(lineTop10, 0.1, { width: "100%", ease: Power0.easeNone }, "together5")
        .to(img10, 0.1, { backgroundSize: "100%", ease: Power0.easeNone }, "together5")
        .to(lineTop2, 0.1, { width: "100%", ease: Power0.easeNone }, "together5")
        .to(lineLeft8, 0.1, { height: "100%", ease: Power0.easeNone }, "together5")
        .to(lineTop8, 0.1, { width: "100%", ease: Power0.easeNone }, "together6")
        .to(lineRight2, 0.1, { height: "100%", ease: Power0.easeNone }, "together6")
        .to(lineBottom2, 0.1, { width: "100%", ease: Power0.easeNone }, "together7")
        .to(img2, 0.1, { backgroundSize: "100%", ease: Power0.easeNone }, "together7")
        .to(lineRight8, 0.1, { height: "100%", ease: Power0.easeNone }, "together7")
        .to(lineBottom5, 0.1, { width: "100%", ease: Power0.easeNone }, "together7")
        .to(lineLeft5, 0.1, { height: "100%", ease: Power0.easeNone }, "together7")
        .to(lineLeft11, 0.1, { height: "100%", ease: Power0.easeNone }, "together8")
        .to(lineBottom8, 0.1, { width: "100%", ease: Power0.easeNone }, "together8")
        .to(img8, 0.1, { backgroundSize: "100%", ease: Power0.easeNone }, "together8")
        .to(lineRight5, 0.1, { height: "100%", ease: Power0.easeNone }, "together8")
        .to(lineBottom11, 0.1, { width: "100%", ease: Power0.easeNone }, "together9")
        .to(lineTop5, 0.1, { width: "100%", ease: Power0.easeNone }, "together9")
        .to(img5, 0.1, { backgroundSize: "100%", ease: Power0.easeNone }, "together9")
        .to(lineLeft3, 0.1, { height: "100%", ease: Power0.easeNone }, "together9")
        .to(lineRight11, 0.1, { height: "100%", ease: Power0.easeNone }, "together10")
        .to(lineTop3, 0.1, { width: "100%", ease: Power0.easeNone }, "together10")
        .to(lineRight3, 0.1, { height: "100%", ease: Power0.easeNone }, "together11")
        .to(lineTop11, 0.1, { width: "100%", ease: Power0.easeNone }, "together11")
        .to(img11, 0.1, { backgroundSize: "100%", ease: Power0.easeNone }, "together11")
        .to(lineLeft9, 0.1, { height: "100%", ease: Power0.easeNone }, "together11")
        .to(lineBottom3, 0.1, { width: "100%", ease: Power0.easeNone }, "together12")
        .to(img3, 0.1, { backgroundSize: "100%", ease: Power0.easeNone }, "together12")
        .to(lineLeft6, 0.1, { height: "100%", ease: Power0.easeNone }, "together12")
        .to(lineTop9, 0.1, { width: "100%", ease: Power0.easeNone }, "together12")
        .to(lineBottom6, 0.1, { width: "100%", ease: Power0.easeNone }, "together13")
        .to(lineRight9, 0.1, { height: "100%", ease: Power0.easeNone }, "together13")
        .to(lineBottom9, 0.1, { width: "100%", ease: Power0.easeNone }, "together14")
        .to(img9, 0.1, { backgroundSize: "100%", ease: Power0.easeNone }, "together14")
        .to(lineRight6, 0.1, { height: "100%", ease: Power0.easeNone }, "together14")
        .to(lineLeft12, 0.1, { height: "100%", ease: Power0.easeNone }, "together14")
        .to(lineTop6, 0.1, { width: "100%", ease: Power0.easeNone }, "together15")
        .to(img6, 0.1, { backgroundSize: "100%", ease: Power0.easeNone }, "together15")
        .to(lineBottom12, 0.1, { width: "100%", ease: Power0.easeNone }, "together15")
        .to(lineRight12, 0.1, { height: "100%", ease: Power0.easeNone })
        .to(lineTop12, 0.1, { width: "100%", ease: Power0.easeNone }, "together16")
        .to(title2, 0.3, { opacity: 1, transform: "translateY(10px)" })
        .to(img12, 0.1, { backgroundSize: "100%", ease: Power0.easeNone }, "together16")
        .to(lineBottom13, 0.1, { width: "100%", ease: Power0.easeNone })
        .to(lineLeft13, 0.1, { height: "100%", ease: Power0.easeNone })
        .to(lineTop13, 0.1, { width: "100%", ease: Power0.easeNone })
        .to(lineRight13, 0.1, { height: "100%", ease: Power0.easeNone })
        .to(img13, 0.1, { backgroundSize: "100%", ease: Power0.easeNone })
        .to(lineLeft14, 0.1, { height: "100%", ease: Power0.easeNone })
        .to(lineBottom14, 0.1, { width: "100%", ease: Power0.easeNone })
        .to(lineRight14, 0.1, { height: "100%", ease: Power0.easeNone })
        .to(lineTop14, 0.1, { width: "100%", ease: Power0.easeNone })
        .to(img14, 0.1, { backgroundSize: "100%", ease: Power0.easeNone })
        .to(title3, 0.3, { opacity: 1, transform: "translateY(10px)" })
        .to(lineBottom15, 0.1, { width: "100%", ease: Power0.easeNone })
        .to(lineLeft15, 0.1, { height: "100%", ease: Power0.easeNone })
